...
HYBRID_DENSE_K = 5         # Dense(FAISS) per-query top-k
HYBRID_SPARSE_K = 5         # Sparse(BM25) per-query top-k
HYBRID_MERGE_TOP_N = 5      # RRF 병합 후 Reranker 전 상위 개수
...
# LLM
OPENAI_MODEL = "gpt-5"          # 답변 생성(RAG·NO_RAG·GENERAL)용 
